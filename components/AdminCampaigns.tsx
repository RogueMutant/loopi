...
function computeScore(c: Campaign): number {
  ...
  let raw = Math.round(
    reward * 0.3 + effort * 0.25 + timing * 0.25 + founder * 0.2,
  );
...
function DimBar({
  ...
  return (
    ...
    >
      <span
        style={{ width: 80, fontSize: 11, color: "#7D8590", flexShrink: 0 }}
      >
        {label}
      </span>
      <div
...
function CampaignRow({
  ...
  const [effortOverride, setEffortOverride] = useState<EffortLabel>(
    campaign.effort_label,
  );
  ...
  return (
    <div
      style={{
        background: "#0D1117",
        border: `0.5px solid ${campaign.needs_founder_review ? "#D2991F44" : "#21262D"}`,
        borderRadius: 12,
        marginBottom: 8,
        overflow: "hidden",
        borderLeft: campaign.needs_founder_review
          ? "3px solid #D2991F"
    ...
    >
      ...
      >
        ...
        <span style={{ color: "#7D8590", fontSize: 12, flexShrink: 0 }}>
          {expanded ? "▲" : "▼"}
        </span>
      </div>
      ...
      {expanded && (
        ...
        >
          ...
          <div>
            ...
            <DimBar
              label="Reward (30%)"
              value={campaign.reward_score}
              color="#00D282"
            />
            <DimBar
              label="Effort (25%)"
              value={campaign.effort_score}
              color="#58A6FF"
            />
            <DimBar
              label="Timing (25%)"
              value={campaign.timing_score}
              color="#D2991F"
            />
            <DimBar
              label="Founder (20%)"
              value={campaign.founder_score ?? 50}
              color="#F85149"
            />
            <div
              style={{
          ...
          <div>
                ...
                {(["low", "medium", "high"] as EffortLabel[]).map((lvl) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "0.5px solid",
                      background:
                        effortOverride === lvl ? "#00D28222" : "transparent",
                      borderColor:
                        effortOverride === lvl ? "#00D282" : "#30363D",
            ...
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontSize: 11, color: "#7D8590", marginBottom: 6 }}>
                ...
                {campaign.needs_founder_review && (
                  <span style={{ marginLeft: 6, color: "#D2991F" }}>
                    — requires research
                  </span>
                )}
              </div>
              ...
              >
                Deductions: Unknown VCs −20 · KOL conc. high −20 · Prev rug −40
                · FDV gap &gt;3× −25
              </div>
            </div>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  background: saving ? "#161B22" : "#00D282",
                  color: saving ? "#7D8590" : "#050D09",
                  border: "none",
                  fontWeight: 500,
                }}
              >
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            color: triggering ? "#7D8590" : "#050D09",
            border: "none",
          }}
        >
